...
if not fs.exists("/lib/db.lua") or alwaysUpdate then -- todo change to for
    ...
    shell.execute("wget ".. proxy .. "https://gitlab.com/lfreew1ndl/opencraftnetoriginal/-/raw/master/db.lua /lib/db.lua")
end
...
if not fs.exists("/lib/durexdb.lua") or alwaysUpdate then
    ...
    shell.execute("wget ".. proxy .. "https://gitlab.com/lfreew1ndl/opencraftnetoriginal/-/raw/master/durexdb.lua /lib/durexdb.lua")
end
...
if not fs.exists("/lib/inMemoryDb.lua") or alwaysUpdate then
    ...
    shell.execute("wget ".. proxy .. "https://gitlab.com/lfreew1ndl/opencraftnetoriginal/-/raw/master/inMemoryDb.lua /lib/inMemoryDb.lua")
end
...
if not fs.exists("/home/db/start.lua") or alwaysUpdate then
    ...
    shell.execute("wget ".. proxy .. "https://gitlab.com/lfreew1ndl/opencraftnetoriginal/-/raw/master/start.lua /home/db/start.lua")
end
...
if not fs.exists("/home/db/int.lua") or alwaysUpdate then
    ...
    shell.execute("wget ".. proxy .. "https://gitlab.com/lfreew1ndl/opencraftnetoriginal/-/raw/master/int.lua /home/db/int.lua")
end
